...
def wishme():
    ...
    if hour>=0 and hour<12:
        speak("wish you a very good morning love")
    elif hour>=12 and hour<18:
        speak(" good afternoon love")
    else:
        speak("good evening love")
        
    speak("hello prachi , I am mini jer your personal chat bot, please tell me how may i help you.")
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('prachisuravse2000@gmail.com', 'prach@1222')
    server.sendmail('prachisuravse2000@gmail.com', to, content)     
    server.close()
        ...
        if 'wikipedia' in query:
           ...
           # music_dir = 'D:\\'
            ...
            try:
                ...
                content = takecommand()
                to = "rathorenvi@gmail.com"    
                sendEmail(to, content)
                speak("Email has been sent!")
            except Exception as e:
                print(e)
                speak("Sorry love. I am not able to send this email at the moment")       
